...
| --- | --- | --- | --- | --- |
| review-package-inventory | Open the package directory and verify required artifacts are present. | .sovryn/discovery-daemon/evidence-packages/DISCOVERY-BENCH-TRIAGE-SECOND-INDEPENDENT-SURVIVOR-001 | Artifact inventory matches the handoff required-artifact table. | queued_for_human_review |
