...
| --- | --- | --- | --- | --- |
| review-package-inventory | Open the package directory and verify required artifacts are present. |  | Artifact inventory matches the handoff required-artifact table. | queued_for_human_review |
