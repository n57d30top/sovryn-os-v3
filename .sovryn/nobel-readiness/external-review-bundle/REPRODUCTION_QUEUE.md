...
| --- | --- | --- | --- | --- |
| review-package-inventory | Open the package directory and verify required artifacts are present. | .sovryn/discovery-daemon/evidence-packages/DISCOVERY-LIFT-INSIGHT-HARD-GEN-BOUNDED-GRAPH-MINOR-OBSTRUCTION-SIGNIFI-4E76B843 | Artifact inventory matches the handoff required-artifact table. | queued_for_human_review |
