...
| --- | --- | --- | --- |
| claim_identity | Does the package preserve the exact candidate identity and claim without scope drift? | .sovryn/discovery-daemon/evidence-packages/DISCOVERY-BENCH-TRIAGE-SECOND-INDEPENDENT-SURVIVOR-001<br>CLAIM_EVIDENCE_BINDINGS.json#candidateId | Reviewer confirms the reviewed claim is the same bounded package claim or requests revision. |
