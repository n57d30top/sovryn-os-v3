...
## Corpus Check
- 194 files · ~1,110,660 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5273 nodes · 17610 edges · 45 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4031 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (716): acceptedPackageHardSeed(), additionalExternalFormalAnchors(), adjacencyFromEdges(), arrayLength(), artifactRefsOf(), AutonomousDiscoveryDaemonService, baseHardSeed(), blockedGeneratorOutputsMarkdown() (+708 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (368): writePilotFixture(), withCandidateHash(), buildScientificMemorySummary(), toPublicCorpusExportModel(), withHash(), buildCorpusGraph(), stableId(), stableHash() (+360 more)
...
Cohesion: 0.01
Nodes (153): configPath(), ensureGitignore(), initConfig(), readText(), createStore(), discoverVerifyCommands(), exists(), readPackageJson() (+145 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (200): buildCandidateInventions(), buildFactoryScore(), buildFeatureMatrix(), buildSourceCards(), buildSourceDiscovery(), candidateWithScore(), externalIdFor(), factoryReading() (+192 more)
...
Cohesion: 0.04
Nodes (65): labCommand(), analysisOperations(), auditText(), buildCapabilityEdges(), buildSafetyScope(), candidateInstruments(), candidatePackages(), capabilitySet() (+57 more)
...
Cohesion: 0.03
Nodes (50): loadConfig(), readJson(), classifyFundCandidate(), fundClassCountsForEinsteinNobelDiscoveryScore(), fundClassRationale(), readPilot(), auditNobelReadinessPublicText(), categoryCounts() (+42 more)
...
Cohesion: 0.05
Nodes (66): assertRejected(), autopublishFixture(), candidate(), createAutopublishFixture(), gitStdout(), makeTargetRepo(), policy(), appendLedger() (+58 more)
...
- **Why does `executeCli()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 26`, `Community 27`?**
