...
## Corpus Check
- 194 files · ~1,194,147 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5805 nodes · 19378 edges · 46 communities detected
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 4257 edges (avg confidence: 0.8)
...
Cohesion: 0.0
Nodes (959): acceptedPackageHardSeed(), additionalExternalFormalAnchors(), adjacencyFromEdges(), arrayOfRecords(), artifactRefsOf(), averageNumbers(), baseHardSeed(), binaryVectorMatroidSummary() (+951 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (397): assertRejected(), candidate(), makeResultRoot(), makeTargetCorpusRepo(), policy(), writeCorpusResult(), writeExternalResult(), writeResultFiles() (+389 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (185): ChemistryRecordAuditorResearchService, commandSummary(), containerNetoffValidationTest(), fixturePint(), happyDataset(), malformedRecord(), matrixRow(), pythonAuditorSource() (+177 more)
...
Cohesion: 0.03
Nodes (59): arrayLength(), AutonomousDiscoveryDaemonService, candidateFromUnknown(), CandidateGraveyardService, compactSearchCycleReceipt(), corpusSeedCandidateBindingValid(), corpusSeedGraveyardReuseBlocked(), cycleFilesByNumber() (+51 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (118): factorySourceReadingFixtures(), patentSourceReadingFixture(), ArxivSearchAdapter, asArray(), asRecord(), boolOrDefault(), clampInt(), CompositePriorArtSearchAdapter (+110 more)
...
Cohesion: 0.04
Nodes (91): appendLedger(), applyStagedCorpus(), autopublishRef(), average(), boolOrDefault(), candidateStatus(), clampInt(), copyExistingCorpusForStaging() (+83 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (63): classifyFundCandidate(), fundClassCountsForEinsteinNobelDiscoveryScore(), fundClassRationale(), nobelReadinessCommand(), aggregatePublicNumber(), arrayOfStrings(), auditNobelReadinessPublicText(), booleanValue() (+55 more)
...
Cohesion: 0.05
Nodes (65): analyzePublicResultQuality(), average(), buildReadabilityReport(), clampScore(), collectTextFiles(), fileText(), finding(), listFiles() (+57 more)
...
Cohesion: 0.05
Nodes (62): concreteSourceTypesRead(), directorySize(), evaluateFactoryGates(), evidenceHashValid(), exists(), findMissionById(), generatedSafetyReviewsPresent(), hashesBound() (+54 more)
...
Cohesion: 0.04
Nodes (89): average(), booleanEvidencePassed(), buildPublicCorpusModel(), buildResultGraph(), buildSearchIndex(), buildVersionGroups(), compactSummary(), comparableTokens() (+81 more)
...
Cohesion: 0.08
Nodes (41): readJson(), theoryCommand(), readPilot(), arrayLength(), benchmarkEvidenceTable(), buildCorpusPatternScan(), calibratePredictions(), compareTheories() (+33 more)

### Community 26 - "Community 26"
Cohesion: 0.09
Nodes (27): strategyCommand(), buildExecutionCycle(), clampInt(), exists(), gate(), listJsonFiles(), numberValue(), pickRankingScores() (+19 more)
...
- **Why does `executeCli()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 13`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 29`?**
