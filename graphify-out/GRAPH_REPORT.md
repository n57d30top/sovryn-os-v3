...
## Corpus Check
- 185 files · ~815,111 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3966 nodes · 13368 edges · 49 communities detected
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 3206 edges (avg confidence: 0.8)
...
Cohesion: 0.02
Nodes (126): clampInt(), commandSummary(), containerValidationTest(), energyAuditorPython(), energyAuditorTestsPython(), energyDataset(), EnergyRecordAuditorResearchService, renderClaimFeatureMatrix() (+118 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (96): configPath(), ensureGitignore(), initConfig(), readText(), createStore(), discoverVerifyCommands(), exists(), readPackageJson() (+88 more)
...
Cohesion: 0.03
Nodes (98): factorySourceReadingFixtures(), patentSourceReadingFixture(), withReadingHash(), assertGitHubTargetSafe(), buildGhRepoCreateCommand(), copyIfExists(), exists(), GitHubPublisher (+90 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (75): createE2EFixture(), e2eFixture(), phase(), replayDiagnosticRepo(), buildNoveltyGapMap(), buildQuestionMap(), concreteSourceTypesRead(), directorySize() (+67 more)
...
- **Why does `executeCli()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 24`, `Community 25`, `Community 27`, `Community 31`, `Community 32`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Are the 517 inferred relationships involving `writeJson()` (e.g. with `theoryFixture()` and `writePriorResult()`) actually correct?**
  _`writeJson()` has 517 INFERRED edges - model-reasoned connections that need verification._
