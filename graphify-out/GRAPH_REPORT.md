...
Cohesion: 0.01
Nodes (767): acceptedPackageHardSeed(), additionalExternalFormalAnchors(), adjacencyFromEdges(), arrayLength(), artifactRefsOf(), baseHardSeed(), binaryVectorMatroidSummary(), bipartitePerfectMatchingExists() (+759 more)
...
Cohesion: 0.03
Nodes (100): statusFromQualityAudit(), domainFromReceipt(), realityDomainFromIndexResult(), unsafeDomainText(), detectDomain(), DiscoveryService, exists(), gate() (+92 more)
...
Cohesion: 0.02
Nodes (94): ensureGitignore(), initConfig(), readText(), createStore(), discoverVerifyCommands(), exists(), readPackageJson(), AppError (+86 more)
...
Cohesion: 0.04
Nodes (37): AutonomousDiscoveryDaemonService, candidateFromUnknown(), CandidateGraveyardService, compactSearchCycleReceipt(), corpusSeedCandidateBindingValid(), corpusSeedGraveyardReuseBlocked(), cycleFilesByNumber(), cycleNumberFromCycleId() (+29 more)
