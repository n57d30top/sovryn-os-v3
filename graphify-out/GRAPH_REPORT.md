...
## Corpus Check
- 194 files · ~1,107,916 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5254 nodes · 17545 edges · 46 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4023 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (706): acceptedPackageHardSeed(), additionalExternalFormalAnchors(), adjacencyFromEdges(), arrayLength(), artifactRefsOf(), AutonomousDiscoveryDaemonService, baseHardSeed(), blockedGeneratorOutputsMarkdown() (+698 more)
...
Cohesion: 0.01
Nodes (172): ChemistryRecordAuditorResearchService, commandSummary(), containerNetoffValidationTest(), fixturePint(), happyDataset(), malformedRecord(), matrixRow(), pythonAuditorSource() (+164 more)
...
Cohesion: 0.02
Nodes (167): factoryPriorArtFixtures(), factorySourceReadingFixtures(), patentSourceReadingFixture(), concreteSourceTypesRead(), directorySize(), evaluateFactoryGates(), evidenceHashValid(), exists() (+159 more)
...
Cohesion: 0.03
Nodes (123): writePilotFixture(), withCandidateHash(), buildScientificMemorySummary(), toPublicCorpusExportModel(), buildCorpusGraph(), stableId(), commandSummary(), containerValidationTest() (+115 more)
...
Cohesion: 0.03
Nodes (51): loadConfig(), readJson(), classifyFundCandidate(), fundClassCountsForEinsteinNobelDiscoveryScore(), fundClassRationale(), nobelReadinessCommand(), readPilot(), auditNobelReadinessPublicText() (+43 more)
...
- **Why does `executeCli()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 13`, `Community 15`, `Community 17`, `Community 19`, `Community 22`, `Community 25`, `Community 27`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Are the 601 inferred relationships involving `writeJson()` (e.g. with `theoryFixture()` and `writePriorResult()`) actually correct?**
  _`writeJson()` has 601 INFERRED edges - model-reasoned connections that need verification._
