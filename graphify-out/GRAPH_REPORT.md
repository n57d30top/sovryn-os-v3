...
## Corpus Check
- 191 files · ~941,704 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4318 nodes · 14799 edges · 47 communities detected
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 3651 edges (avg confidence: 0.8)
...
- `createE2EFixture()` --calls--> `makeTempRepo()`  [INFERRED]
  /Users/sovryn/Desktop/sovryn-os-v3/tests/e2e.test.ts → /Users/sovryn/Desktop/sovryn-os-v3/src/testkit/temp-repo.ts
...
Cohesion: 0.02
Nodes (161): acceptedPackageHardSeed(), arrayLength(), AutonomousDiscoveryDaemonService, baseHardSeed(), buildAnomalyFamilies(), buildCandidateIdeas(), buildCounterexampleResults(), buildDaemonKillWeek() (+153 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (186): writeJson(), scienceCommand(), aggregateMetrics(), analyzeSafety(), assertDatasetCandidateSafe(), assertReproductionPlanRunnable(), assertSafeScope(), average() (+178 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (148): withHash(), writePilotFixture(), withCandidateHash(), buildScientificMemorySummary(), toPublicCorpusExportModel(), withHash(), buildCorpusGraph(), stableId() (+140 more)
...
Cohesion: 0.02
Nodes (133): arrayOfRecords(), buildFactoryMode(), dedupeFeatures(), extractFeatures(), extractNoveltyGaps(), factorySourceReadingFixtures(), patentSourceReadingFixture(), generateCandidates() (+125 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (79): unsafeDomainText(), criticalCheck(), labCommand(), analysisOperations(), auditText(), buildCapabilityEdges(), buildSafetyScope(), candidateInstruments() (+71 more)
...
Cohesion: 0.03
Nodes (69): auditFromGates(), baselinesForDomain(), candidatesForDomain(), challengeTask(), clampInt(), exists(), FieldGradeService, fieldGradeSummary() (+61 more)
...
Cohesion: 0.05
Nodes (42): repoCommand(), classifyFixture(), appendJsonArray(), auditRepoPublicText(), DependencyPinningAnalyzer, ensureRepoDirs(), EnvironmentSpecificityAnalyzer, ExamplePathAnalyzer (+34 more)
...
Cohesion: 0.05
Nodes (50): factoryPriorArtFixtures(), readJson(), assertOpportunityEngineEnabled(), baseSignals(), boolOrDefault(), buildOpportunity(), buildRanking(), clampInt() (+42 more)
...
Cohesion: 0.07
Nodes (40): qualityCommand(), boolOrDefault(), buildFactoryFindings(), buildRubric(), clampInt(), collectTextFiles(), dimension(), dimensionFromLinked() (+32 more)
...
- **Why does `executeCli()` connect `Community 0` to `Community 32`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 24`, `Community 28`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Are the 551 inferred relationships involving `writeJson()` (e.g. with `theoryFixture()` and `writePriorResult()`) actually correct?**
  _`writeJson()` has 551 INFERRED edges - model-reasoned connections that need verification._
