...
## Corpus Check
- 194 files · ~1,083,156 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5052 nodes · 16919 edges · 46 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 3957 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (577): acceptedPackageHardSeed(), arrayLength(), artifactRefsOf(), AutonomousDiscoveryDaemonService, baseHardSeed(), boundedInstrumentScore(), broaderClaimText(), buildAnomalyFamilies() (+569 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (266): assertRejected(), candidate(), makeResultRoot(), makeTargetCorpusRepo(), policy(), writeCorpusResult(), writeExternalResult(), writeResultFiles() (+258 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (221): analyzePublicResultQuality(), average(), buildReadabilityReport(), clampScore(), collectTextFiles(), fileText(), finding(), listFiles() (+213 more)
...
Cohesion: 0.02
Nodes (130): configPath(), ensureGitignore(), initConfig(), loadConfig(), readText(), createStore(), discoverVerifyCommands(), exists() (+122 more)
...
Cohesion: 0.04
Nodes (82): looksLikeNetworkCommand(), statusFromQualityAudit(), domainFromReceipt(), realityDomainFromIndexResult(), unsafeDomainText(), criticalCheck(), ExhaustiveBoundTester, labCommand() (+74 more)
...
Cohesion: 0.03
Nodes (80): factorySourceReadingFixtures(), patentSourceReadingFixture(), exists(), InventionService, slugify(), titleFromBrief(), phaseEvidenceFileName(), writePhaseEvidence() (+72 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (64): factoryPriorArtFixtures(), appendFactoryCandidateDocs(), assertFactoryEnabled(), boolOrDefault(), clampInt(), copyIfExists(), createFactoryId(), evidenceRefs() (+56 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (61): average(), average(), buildQualityReport(), roundShare(), averageEvidenceStrength(), candidateWithScore(), roundScore(), repoCommand() (+53 more)
...
Cohesion: 0.03
Nodes (117): booleanEvidencePassed(), buildPublicCorpusModel(), buildResultGraph(), buildSearchIndex(), buildVersionGroups(), compactSummary(), comparableTokens(), compareShowcaseCandidates() (+109 more)
...
Cohesion: 0.03
Nodes (82): asRecordNumber(), blockedInsightBirthsMarkdown(), bulletList(), CandidateYieldController, candidateYieldMarkdown(), classifyFailedEvidenceRefs(), collectEvidenceRefs(), DiscoveryFrictionHealthService (+74 more)
...
Cohesion: 0.05
Nodes (56): researchCommand(), assertOpportunityEngineEnabled(), baseSignals(), boolOrDefault(), buildOpportunity(), buildRanking(), clampInt(), clampScore() (+48 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (42): qualityCommand(), boolOrDefault(), buildFactoryFindings(), buildRubric(), clampInt(), collectTextFiles(), dimension(), dimensionFromLinked() (+34 more)
...
Cohesion: 0.06
Nodes (21): classifyFundCandidate(), fundClassCountsForEinsteinNobelDiscoveryScore(), fundClassRationale(), nobelReadinessCommand(), auditNobelReadinessPublicText(), fileExists(), hasNobelReadinessArtifacts(), isFundClassAssessment() (+13 more)
...
- **Why does `nowIso()` connect `Community 6` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 29`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `executeCli()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 30`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Are the 583 inferred relationships involving `writeJson()` (e.g. with `theoryFixture()` and `writePriorResult()`) actually correct?**
  _`writeJson()` has 583 INFERRED edges - model-reasoned connections that need verification._
