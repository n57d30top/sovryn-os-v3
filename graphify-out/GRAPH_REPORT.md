...
## Corpus Check
- 194 files · ~1,081,238 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5035 nodes · 16875 edges · 48 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 3954 edges (avg confidence: 0.8)
...
8. `AutonomousDiscoveryDaemonService` - 92 edges
9. `number()` - 90 edges
10. `withEvidenceHash()` - 89 edges
...
Cohesion: 0.01
Nodes (563): acceptedPackageHardSeed(), arrayLength(), artifactRefsOf(), AutonomousDiscoveryDaemonService, baseHardSeed(), boundedInstrumentScore(), broaderClaimText(), buildAnomalyFamilies() (+555 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (335): assertRejected(), candidate(), makeResultRoot(), makeTargetCorpusRepo(), policy(), writeCorpusResult(), writeExternalResult(), writeResultFiles() (+327 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (230): ChemistryRecordAuditorResearchService, commandSummary(), containerNetoffValidationTest(), fixturePint(), happyDataset(), malformedRecord(), matrixRow(), pythonAuditorSource() (+222 more)
...
Cohesion: 0.04
Nodes (81): domainFromReceipt(), realityDomainFromIndexResult(), unsafeDomainText(), criticalCheck(), labCommand(), analysisOperations(), auditText(), buildCapabilityEdges() (+73 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (115): factorySourceReadingFixtures(), patentSourceReadingFixture(), assertGitHubTargetSafe(), buildGhRepoCreateCommand(), copyIfExists(), exists(), GitHubPublisher, preparePublicEvidence() (+107 more)
...
Cohesion: 0.03
Nodes (77): loadConfig(), factoryPriorArtFixtures(), readJson(), readPilot(), assertOpportunityEngineEnabled(), baseSignals(), boolOrDefault(), buildOpportunity() (+69 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (116): booleanEvidencePassed(), buildPublicCorpusModel(), buildResultGraph(), buildScientificMemorySummary(), buildSearchIndex(), buildVersionGroups(), compactSummary(), comparableTokens() (+108 more)
...
Cohesion: 0.08
Nodes (18): createStore(), FileStore, countLines(), GitAdapter, listFiles(), numstat(), shellQuote(), hashVerifyEvidence() (+10 more)
...
Cohesion: 0.07
Nodes (21): auditNobelPublicText(), DiscoveryCandidateScorer, DiscoveryHypothesisGenerator, domain(), domainFromHypothesis(), ensureNobelDirs(), executionFor(), HighImpactDomainSelector (+13 more)
...
- **Why does `executeCli()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 14`, `Community 17`, `Community 19`, `Community 20`, `Community 24`, `Community 25`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Are the 582 inferred relationships involving `writeJson()` (e.g. with `theoryFixture()` and `writePriorResult()`) actually correct?**
  _`writeJson()` has 582 INFERRED edges - model-reasoned connections that need verification._
