...
## Corpus Check
- 187 files · ~835,370 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4059 nodes · 13686 edges · 46 communities detected
...
Cohesion: 0.01
Nodes (153): configPath(), ensureGitignore(), initConfig(), loadConfig(), readText(), createStore(), discoverVerifyCommands(), exists() (+145 more)
...
Cohesion: 0.02
Nodes (122): buildScientificMemorySummary(), toPublicCorpusExportModel(), buildCorpusGraph(), arrayOfRecords(), buildBenchmarkPlan(), buildCandidateInventions(), buildClaimElementMap(), buildCounterEvidence() (+114 more)
...
Cohesion: 0.02
Nodes (118): factorySourceReadingFixtures(), patentSourceReadingFixture(), assertGitHubTargetSafe(), buildGhRepoCreateCommand(), copyIfExists(), exists(), GitHubPublisher, preparePublicEvidence() (+110 more)
...
Cohesion: 0.04
Nodes (105): analyzePublicResultQuality(), average(), buildReadabilityReport(), clampScore(), collectTextFiles(), fileText(), finding(), listFiles() (+97 more)
...
Cohesion: 0.03
Nodes (63): AutonomousDiscoveryDaemonService, buildAnomalyFamilies(), buildCandidateIdeas(), buildCounterexampleResults(), buildDaemonKillWeek(), buildDeathGateResults(), buildFrozenPredictions(), buildHoldoutResults() (+55 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (45): auditReviewPublicText(), decisionFromReceipt(), ensureReviewDirs(), EvidenceReceiptService, executionNeedForFamily(), ExecutionWavePlanner, ExternalReviewScientistService, ExternalTargetMiner (+37 more)
...
Cohesion: 0.06
Nodes (44): auditFromGates(), buildBaselineTools(), buildExternalClaimBindings(), buildHoldoutTasks(), buildMethodIdeas(), buildProblemCandidates(), exists(), ExternalProductionService (+36 more)
...
- **Why does `executeCli()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 25`, `Community 27`, `Community 28`, `Community 30`?**
