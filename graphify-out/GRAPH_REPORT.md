...
## Corpus Check
- 194 files · ~1,046,089 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4854 nodes · 16391 edges · 46 communities detected
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 3892 edges (avg confidence: 0.8)
...
9. `AutonomousDiscoveryDaemonService` - 85 edges
10. `withEvidenceHash()` - 82 edges
...
Cohesion: 0.01
Nodes (431): acceptedPackageHardSeed(), arrayLength(), AutonomousDiscoveryDaemonService, baseHardSeed(), boundedInstrumentScore(), broaderClaimText(), buildAnomalyFamilies(), buildCandidateIdeas() (+423 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (315): assertRejected(), candidate(), makeResultRoot(), makeTargetCorpusRepo(), policy(), writeCorpusResult(), writeExternalResult(), writeResultFiles() (+307 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (194): phase(), factoryPriorArtFixtures(), factorySourceReadingFixtures(), patentSourceReadingFixture(), concreteSourceTypesRead(), directorySize(), evaluateFactoryGates(), evidenceHashValid() (+186 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (189): writePilotFixture(), withCandidateHash(), toPublicCorpusExportModel(), buildCorpusGraph(), stableId(), commandSummary(), containerValidationTest(), energyAuditorPython() (+181 more)
...
Cohesion: 0.04
Nodes (79): domainFromReceipt(), realityDomainFromIndexResult(), unsafeDomainText(), criticalCheck(), labCommand(), rejectForbiddenSecretArgs(), analysisOperations(), auditText() (+71 more)
...
Cohesion: 0.04
Nodes (74): asRecordNumber(), blockedInsightBirthsMarkdown(), bulletList(), CandidateYieldController, candidateYieldMarkdown(), classifyFailedEvidenceRefs(), collectEvidenceRefs(), DiscoveryFrictionHealthService (+66 more)
...
- **Why does `executeCli()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 30`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Are the 574 inferred relationships involving `writeJson()` (e.g. with `theoryFixture()` and `writePriorResult()`) actually correct?**
  _`writeJson()` has 574 INFERRED edges - model-reasoned connections that need verification._
