...
## Corpus Check
- 194 files · ~1,055,744 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4893 nodes · 16492 edges · 48 communities detected
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 3909 edges (avg confidence: 0.8)
...
9. `number()` - 87 edges
10. `AutonomousDiscoveryDaemonService` - 86 edges
...
Cohesion: 0.01
Nodes (468): acceptedPackageHardSeed(), arrayLength(), AutonomousDiscoveryDaemonService, baseHardSeed(), boundedInstrumentScore(), broaderClaimText(), buildAnomalyFamilies(), buildCandidateIdeas() (+460 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (322): writePilotFixture(), withCandidateHash(), buildScientificMemorySummary(), toPublicCorpusExportModel(), buildCorpusGraph(), stableId(), commandSummary(), containerValidationTest() (+314 more)
...
Cohesion: 0.01
Nodes (224): toAppError(), arrayOfRecords(), buildFactoryMode(), dedupeFeatures(), extractFeatures(), extractNoveltyGaps(), factoryPriorArtFixtures(), factorySourceReadingFixtures() (+216 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (102): domainFromReceipt(), realityDomainFromIndexResult(), unsafeDomainText(), criticalCheck(), auditReviewPublicText(), decisionFromReceipt(), ensureReviewDirs(), EvidenceReceiptService (+94 more)
...
Cohesion: 0.03
Nodes (61): configExists(), configPath(), ensureGitignore(), initConfig(), loadConfig(), readText(), createStore(), discoverVerifyCommands() (+53 more)
...
Cohesion: 0.04
Nodes (79): asRecordNumber(), blockedInsightBirthsMarkdown(), bulletList(), CandidateYieldController, candidateYieldMarkdown(), classifyFailedEvidenceRefs(), collectEvidenceRefs(), DiscoveryFrictionHealthService (+71 more)
...
- **Why does `executeCli()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 23`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Are the 575 inferred relationships involving `writeJson()` (e.g. with `theoryFixture()` and `writePriorResult()`) actually correct?**
  _`writeJson()` has 575 INFERRED edges - model-reasoned connections that need verification._
