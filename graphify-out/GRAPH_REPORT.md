...
## Corpus Check
- 194 files · ~1,123,198 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5372 nodes · 17874 edges · 48 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4066 edges (avg confidence: 0.8)
...
Cohesion: 0.0
Nodes (796): acceptedPackageHardSeed(), additionalExternalFormalAnchors(), adjacencyFromEdges(), arrayLength(), artifactRefsOf(), AutonomousDiscoveryDaemonService, baseHardSeed(), binaryVectorMatroidSummary() (+788 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (391): assertRejected(), candidate(), makeResultRoot(), makeTargetCorpusRepo(), policy(), writeCorpusResult(), writeExternalResult(), writeResultFiles() (+383 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (234): analyzePublicResultQuality(), average(), buildReadabilityReport(), clampScore(), collectTextFiles(), fileText(), finding(), listFiles() (+226 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (186): factoryPriorArtFixtures(), factorySourceReadingFixtures(), patentSourceReadingFixture(), concreteSourceTypesRead(), directorySize(), evaluateFactoryGates(), evidenceHashValid(), exists() (+178 more)
...
Cohesion: 0.04
Nodes (78): domainFromReceipt(), realityDomainFromIndexResult(), unsafeDomainText(), labCommand(), analysisOperations(), auditText(), buildCapabilityEdges(), buildSafetyScope() (+70 more)
...
Cohesion: 0.03
Nodes (83): asRecordNumber(), blockedInsightBirthsMarkdown(), bulletList(), CandidateYieldController, candidateYieldMarkdown(), classifyFailedEvidenceRefs(), collectEvidenceRefs(), DiscoveryFrictionHealthService (+75 more)
...
- **Why does `executeCli()` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 12`, `Community 14`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 25`, `Community 28`, `Community 29`, `Community 31`?**
