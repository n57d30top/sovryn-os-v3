...
## Corpus Check
- 194 files · ~1,057,990 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4916 nodes · 16553 edges · 47 communities detected
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 3917 edges (avg confidence: 0.8)
...
9. `number()` - 88 edges
10. `AutonomousDiscoveryDaemonService` - 87 edges
...
Cohesion: 0.01
Nodes (488): renderCorpusQualityReport(), acceptedPackageHardSeed(), arrayLength(), AutonomousDiscoveryDaemonService, baseHardSeed(), boundedInstrumentScore(), broaderClaimText(), buildAnomalyFamilies() (+480 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (319): writePilotFixture(), withCandidateHash(), buildScientificMemorySummary(), toPublicCorpusExportModel(), withHash(), buildCorpusGraph(), stableId(), buildBenchmarkPlan() (+311 more)
...
Cohesion: 0.02
Nodes (130): arrayOf(), auditValidationPublicText(), BlindHoldoutSelector, CounterexampleSearchService, countJsonFiles(), DiscoveryValidationService, ensureValidationDirs(), existsJson() (+122 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (161): arrayOfRecords(), buildFactoryMode(), dedupeFeatures(), extractFeatures(), extractNoveltyGaps(), factoryPriorArtFixtures(), factorySourceReadingFixtures(), patentSourceReadingFixture() (+153 more)
...
Cohesion: 0.02
Nodes (82): configExists(), configPath(), ensureGitignore(), initConfig(), loadConfig(), readText(), createStore(), discoverVerifyCommands() (+74 more)
...
Cohesion: 0.04
Nodes (80): asRecordNumber(), blockedInsightBirthsMarkdown(), bulletList(), CandidateYieldController, candidateYieldMarkdown(), classifyFailedEvidenceRefs(), collectEvidenceRefs(), DiscoveryFrictionHealthService (+72 more)
...
Cohesion: 0.07
Nodes (39): qualityCommand(), boolOrDefault(), buildFactoryFindings(), buildRubric(), clampInt(), collectTextFiles(), dimension(), dimensionFromLinked() (+31 more)
...
Cohesion: 0.08
Nodes (26): buildExecutionCycle(), clampInt(), exists(), gate(), listJsonFiles(), numberValue(), opportunitiesForSeed(), pickRankingScores() (+18 more)
...
- **Why does `nowIso()` connect `Community 7` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `executeCli()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 12`, `Community 14`, `Community 17`, `Community 19`, `Community 20`, `Community 23`, `Community 25`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Are the 577 inferred relationships involving `writeJson()` (e.g. with `theoryFixture()` and `writePriorResult()`) actually correct?**
  _`writeJson()` has 577 INFERRED edges - model-reasoned connections that need verification._
