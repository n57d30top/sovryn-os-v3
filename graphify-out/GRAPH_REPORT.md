...
## Corpus Check
- 194 files · ~1,085,323 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5056 nodes · 16938 edges · 49 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 3959 edges (avg confidence: 0.8)
...
8. `AutonomousDiscoveryDaemonService` - 93 edges
9. `withEvidenceHash()` - 92 edges
10. `number()` - 90 edges
...
Cohesion: 0.01
Nodes (579): renderCorpusQualityReport(), acceptedPackageHardSeed(), arrayLength(), artifactRefsOf(), AutonomousDiscoveryDaemonService, baseHardSeed(), boundedInstrumentScore(), broaderClaimText() (+571 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (225): writePilotFixture(), withCandidateHash(), buildScientificMemorySummary(), toPublicCorpusExportModel(), withHash(), buildCorpusGraph(), stableId(), commandSummary() (+217 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (267): assertRejected(), candidate(), makeResultRoot(), makeTargetCorpusRepo(), policy(), writeCorpusResult(), writeExternalResult(), writeResultFiles() (+259 more)
...
Cohesion: 0.02
Nodes (99): configExists(), configPath(), ensureGitignore(), initConfig(), loadConfig(), readText(), createStore(), discoverVerifyCommands() (+91 more)
...
Cohesion: 0.04
Nodes (79): statusFromQualityAudit(), domainFromReceipt(), realityDomainFromIndexResult(), unsafeDomainText(), criticalCheck(), labCommand(), analysisOperations(), auditText() (+71 more)
...
Cohesion: 0.02
Nodes (124): asRecordNumber(), blockedInsightBirthsMarkdown(), bulletList(), CandidateYieldController, candidateYieldMarkdown(), classifyFailedEvidenceRefs(), collectEvidenceRefs(), DiscoveryFrictionHealthService (+116 more)
...
Cohesion: 0.03
Nodes (94): assertGitHubTargetSafe(), buildGhRepoCreateCommand(), copyIfExists(), exists(), GitHubPublisher, preparePublicEvidence(), writeFinalVerifySummary(), writePublicSourceSearchSummary() (+86 more)
...
Cohesion: 0.05
Nodes (69): concreteSourceTypesRead(), directorySize(), evaluateFactoryGates(), evidenceHashValid(), exists(), findMissionById(), generatedSafetyReviewsPresent(), hashesBound() (+61 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (85): appendLedger(), applyStagedCorpus(), autopublishRef(), boolOrDefault(), candidateStatus(), clampInt(), copyExistingCorpusForStaging(), CorpusAutopublisher (+77 more)
...
## Knowledge Gaps
- **Thin community `Community 37`** (2 nodes): `describeOpenInvention()`, `index.js`
...
- **Thin community `Community 47`** (1 nodes): `instrument.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `prototype.test.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `nowIso()` connect `Community 6` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `executeCli()` connect `Community 2` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 15`, `Community 16`, `Community 18`, `Community 20`, `Community 23`, `Community 25`, `Community 26`, `Community 28`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Are the 585 inferred relationships involving `writeJson()` (e.g. with `theoryFixture()` and `writePriorResult()`) actually correct?**
  _`writeJson()` has 585 INFERRED edges - model-reasoned connections that need verification._
