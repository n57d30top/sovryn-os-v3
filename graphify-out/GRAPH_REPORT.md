...
## Corpus Check
- 120 files · ~467,050 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2123 nodes · 6701 edges · 27 communities detected
- Extraction: 80% EXTRACTED · 20% INFERRED · 0% AMBIGUOUS · INFERRED: 1334 edges (avg confidence: 0.8)
...
1. `writeJson()` - 248 edges
2. `nowIso()` - 181 edges
3. `hashEvidence()` - 144 edges
4. `executeCli()` - 110 edges
5. `ScienceService` - 94 edges
6. `withEvidenceHash()` - 70 edges
7. `runCommand()` - 64 edges
8. `scienceCommand()` - 50 edges
9. `makeTempRepo()` - 42 edges
10. `stableId()` - 40 edges
...
- `createPublicBetaFixture()` --calls--> `makeTempRepo()`  [INFERRED]
  /Users/sovryn/Desktop/sovryn-os-v3/tests/public-beta.test.ts → /Users/sovryn/Desktop/sovryn-os-v3/src/testkit/temp-repo.ts
...
Cohesion: 0.03
Nodes (172): writeJson(), scienceCommand(), aggregateMetrics(), analyzeSafety(), assertDatasetCandidateSafe(), assertReproductionPlanRunnable(), assertSafeScope(), average() (+164 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (166): initializedRepo(), createOperationsFixture(), createPilotAllFixture(), must(), operationsFixture(), pilotAllFixture(), betaFixture(), createBetaFixture() (+158 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (101): looksLikeNetworkCommand(), networkDenyEnv(), runCommand(), configExists(), configPath(), ensureGitignore(), initConfig(), loadConfig() (+93 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (79): arrayOfRecords(), averageEvidenceStrength(), buildBenchmarkPlan(), buildCandidateInventions(), buildClaimElementMap(), buildCounterEvidence(), buildExperimentPlan(), buildFactoryScore() (+71 more)
...
Cohesion: 0.04
Nodes (58): appendFactoryCandidateDocs(), writeCandidatePrototype(), assertGitHubTargetSafe(), buildGhRepoCreateCommand(), copyIfExists(), exists(), GitHubPublisher, preparePublicEvidence() (+50 more)
...
Cohesion: 0.11
Nodes (24): createTemporaryCorpusRepo(), createTemporarySovrynRepo(), docsStatus(), exists(), gate(), productRoot(), publicBetaRef(), PublicBetaService (+16 more)
...
- **Why does `writeJson()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`?**
  _High betweenness centrality (0.164) - this node is a cross-community bridge._
- **Why does `nowIso()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `executeCli()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 10`, `Community 11`, `Community 13`, `Community 19`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Are the 247 inferred relationships involving `writeJson()` (e.g. with `makeTargetRepo()` and `writeResult()`) actually correct?**
  _`writeJson()` has 247 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 142 inferred relationships involving `hashEvidence()` (e.g. with `replacePriorArtEvidence()` and `replaceSourceReadingsEvidence()`) actually correct?**
  _`hashEvidence()` has 142 INFERRED edges - model-reasoned connections that need verification._
- **Are the 77 inferred relationships involving `executeCli()` (e.g. with `createPublicBetaFixture()` and `createStrictRunWithoutSharedState()`) actually correct?**
  _`executeCli()` has 77 INFERRED edges - model-reasoned connections that need verification._
