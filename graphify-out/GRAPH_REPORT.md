...
## Corpus Check
- 192 files · ~1,013,846 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4650 nodes · 15854 edges · 47 communities detected
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 3798 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (362): acceptedPackageHardSeed(), arrayLength(), AutonomousDiscoveryDaemonService, baseHardSeed(), boundedInstrumentScore(), broaderClaimText(), buildAnomalyFamilies(), buildCandidateIdeas() (+354 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (243): assertRejected(), candidate(), makeResultRoot(), makeTargetCorpusRepo(), policy(), writeCorpusResult(), writeExternalResult(), writeResultFiles() (+235 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (163): configPath(), ensureGitignore(), initConfig(), readText(), assertRejected(), autopublishFixture(), candidate(), createAutopublishFixture() (+155 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (166): writePilotFixture(), withCandidateHash(), toPublicCorpusExportModel(), buildCorpusGraph(), stableId(), commandSummary(), containerValidationTest(), energyAuditorPython() (+158 more)
...
Cohesion: 0.02
Nodes (109): factorySourceReadingFixtures(), patentSourceReadingFixture(), exists(), InventionService, slugify(), titleFromBrief(), phaseEvidenceFileName(), writePhaseEvidence() (+101 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (73): domainFromReceipt(), realityDomainFromIndexResult(), unsafeDomainText(), labCommand(), analysisOperations(), auditText(), buildCapabilityEdges(), buildSafetyScope() (+65 more)
...
Cohesion: 0.04
Nodes (40): arrayOf(), auditValidationPublicText(), BlindHoldoutSelector, CounterexampleSearchService, countJsonFiles(), DiscoveryValidationService, ensureValidationDirs(), existsJson() (+32 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (73): arrayOfStrings(), buildDuplicateMap(), comparableTokens(), corpusGate(), CorpusService, exists(), explainSummary(), isRecord() (+65 more)
...
Cohesion: 0.03
Nodes (76): auditFormalPublicText(), baselineFor(), BoundedToFormalBridge, candidateFixture(), ConjectureCandidateScorer, ConjectureFamilyBuilder, conjectureFamilyFixture(), CounterexampleSearchRunner (+68 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (65): phase(), concreteSourceTypesRead(), directorySize(), evaluateFactoryGates(), evidenceHashValid(), exists(), findMissionById(), generatedSafetyReviewsPresent() (+57 more)
...
Cohesion: 0.06
Nodes (35): auditFromGates(), baselinesForDomain(), candidatesForDomain(), challengeResult(), challengeTask(), clampInt(), exists(), FieldGradeService (+27 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (58): auditRef(), AuditService, countKind(), errorMessage(), fileNameFindings(), gate(), hasKind(), isDependencyOrCachePath() (+50 more)
...
Cohesion: 0.05
Nodes (50): loadConfig(), factoryPriorArtFixtures(), readJson(), readPilot(), assertOpportunityEngineEnabled(), baseSignals(), boolOrDefault(), buildOpportunity() (+42 more)
...
- **Why does `writeJson()` connect `Community 8` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`?**
...
- **Why does `executeCli()` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Are the 567 inferred relationships involving `writeJson()` (e.g. with `theoryFixture()` and `writePriorResult()`) actually correct?**
  _`writeJson()` has 567 INFERRED edges - model-reasoned connections that need verification._
