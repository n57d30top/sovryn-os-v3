...
## Corpus Check
- 194 files · ~1,151,538 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5520 nodes · 18392 edges · 47 communities detected
...
Cohesion: 0.0
Nodes (896): countBy(), acceptedPackageHardSeed(), additionalExternalFormalAnchors(), adjacencyFromEdges(), arrayLength(), artifactRefsOf(), AutonomousDiscoveryDaemonService, baseHardSeed() (+888 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (334): assertRejected(), candidate(), makeResultRoot(), makeTargetCorpusRepo(), policy(), writeCorpusResult(), writeExternalResult(), writeResultFiles() (+326 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (201): configExists(), configPath(), loadConfig(), writePilotFixture(), withCandidateHash(), withHash(), buildScientificMemorySummary(), toPublicCorpusExportModel() (+193 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (213): factoryPriorArtFixtures(), concreteSourceTypesRead(), directorySize(), evaluateFactoryGates(), evidenceHashValid(), exists(), findMissionById(), generatedSafetyReviewsPresent() (+205 more)
...
Cohesion: 0.02
Nodes (128): auditRef(), AuditService, countKind(), errorMessage(), fileNameFindings(), gate(), hasKind(), isDependencyOrCachePath() (+120 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (80): domainFromReceipt(), realityDomainFromIndexResult(), unsafeDomainText(), labCommand(), analysisOperations(), auditText(), buildCapabilityEdges(), buildSafetyScope() (+72 more)
...
Cohesion: 0.03
Nodes (56): mechanismExecutionTarget(), mechanismModuleName(), MechanismPlanExecutor, sharedMechanismTool(), classifyFundCandidate(), fundClassCountsForEinsteinNobelDiscoveryScore(), fundClassRationale(), auditNobelReadinessPublicText() (+48 more)
...
Cohesion: 0.05
Nodes (73): analyzePublicResultQuality(), average(), buildReadabilityReport(), clampScore(), collectTextFiles(), fileText(), finding(), listFiles() (+65 more)
...
- **Why does `executeCli()` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 17`, `Community 20`, `Community 21`, `Community 23`, `Community 26`, `Community 29`, `Community 30`?**
