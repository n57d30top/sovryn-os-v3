...
## Corpus Check
- 194 files · ~1,129,474 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5387 nodes · 17935 edges · 47 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4074 edges (avg confidence: 0.8)
...
Cohesion: 0.0
Nodes (808): acceptedPackageHardSeed(), additionalExternalFormalAnchors(), adjacencyFromEdges(), arrayLength(), artifactRefsOf(), AutonomousDiscoveryDaemonService, baseHardSeed(), binaryVectorMatroidSummary() (+800 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (342): writePilotFixture(), withCandidateHash(), buildScientificMemorySummary(), toPublicCorpusExportModel(), buildCorpusGraph(), stableId(), commandSummary(), containerValidationTest() (+334 more)
...
Cohesion: 0.01
Nodes (220): phase(), arrayOfRecords(), buildFactoryMode(), dedupeFeatures(), extractFeatures(), extractNoveltyGaps(), factoryPriorArtFixtures(), factorySourceReadingFixtures() (+212 more)
...
Cohesion: 0.04
Nodes (74): domainFromReceipt(), realityDomainFromIndexResult(), unsafeDomainText(), criticalCheck(), labCommand(), rejectForbiddenSecretArgs(), analysisOperations(), auditText() (+66 more)
...
Cohesion: 0.03
Nodes (112): analyzePublicResultQuality(), average(), buildReadabilityReport(), clampScore(), collectTextFiles(), fileText(), finding(), listFiles() (+104 more)
...
Cohesion: 0.04
Nodes (72): blockedInsightBirthsMarkdown(), bulletList(), CandidateYieldController, candidateYieldMarkdown(), classifyFailedEvidenceRefs(), collectEvidenceRefs(), DiscoveryFrictionHealthService, emptyFailureTypeCounts() (+64 more)
...
- **Why does `executeCli()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 28`?**
