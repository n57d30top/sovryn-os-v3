...
## Corpus Check
- 194 files · ~1,151,195 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5518 nodes · 18384 edges · 45 communities detected
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 4129 edges (avg confidence: 0.8)
...
Cohesion: 0.0
Nodes (924): acceptedPackageHardSeed(), additionalExternalFormalAnchors(), adjacencyFromEdges(), arrayLength(), artifactRefsOf(), AutonomousDiscoveryDaemonService, baseHardSeed(), binaryVectorMatroidSummary() (+916 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (285): assertRejected(), candidate(), makeResultRoot(), makeTargetCorpusRepo(), policy(), writeCorpusResult(), writeExternalResult(), writeResultFiles() (+277 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (169): ChemistryRecordAuditorResearchService, commandSummary(), renderFactoryReport(), renderHumanReviewChecklist(), renderPilotReport(), renderPublicReadme(), renderSafetyReview(), renderToolDesign() (+161 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (148): containerNetoffValidationTest(), fixturePint(), happyDataset(), malformedRecord(), matrixRow(), pythonAuditorSource(), pythonAuditorTests(), record() (+140 more)
...
Cohesion: 0.02
Nodes (153): factoryPriorArtFixtures(), factorySourceReadingFixtures(), patentSourceReadingFixture(), concreteSourceTypesRead(), directorySize(), evaluateFactoryGates(), evidenceHashValid(), exists() (+145 more)
...
Cohesion: 0.05
Nodes (72): analyzePublicResultQuality(), average(), buildReadabilityReport(), clampScore(), collectTextFiles(), fileText(), finding(), listFiles() (+64 more)
...
- **Why does `executeCli()` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 14`, `Community 15`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Are the 616 inferred relationships involving `writeJson()` (e.g. with `theoryFixture()` and `writePriorResult()`) actually correct?**
  _`writeJson()` has 616 INFERRED edges - model-reasoned connections that need verification._
