...
Commands:
  ...
  sovryn discover-daemon generator-claim-lift-propose [--json]
  sovryn discover-daemon generator-claim-lift [--json]
  sovryn discover-daemon generator-claim-lift-pressure [--json]
  sovryn discover-daemon generator-claim-lift-experiment [--json]
  sovryn discover-daemon generator-claim-lift-source-signal [--json]
  sovryn discover-daemon generator-claim-lift-novelty-pressure [--json]
  sovryn discover-daemon generator-claim-lift-death-memory [--json]
  sovryn discover-daemon generator-claim-lift-candidate [--json]
  sovryn discover-daemon generator-claim-lift-rebind [--json]
  sovryn discover-daemon generator-claim-lift-intake [--json]
  ...
  sovryn discover-daemon formal-anchor-audit [--json]
  ...
  sovryn discover-daemon discovery-anchor-run [--json]
  sovryn discover-daemon discovery-anchor-run-audit [--json]
  ...
  sovryn discover-daemon strategy-memory-gate [--json]
  sovryn discover-daemon memory-gated-benchmark-upgrade [--json]
  sovryn discover-daemon insight-temporal-recurrence-promotion [--json]
  sovryn discover-daemon insight-temporal-replay-repair [--json]
  ...
  sovryn discover-daemon receipt-first-selectivity [--live-openml] [--json]
	  ...
	  sovryn discover-daemon receipt-first-survival-potential [--live-openml] [--json]
	  sovryn discover-daemon receipt-first-v2-survivor-yield [--live-openml] [--json]
	  sovryn discover-daemon deep-validation-gold-set-calibration [--live-openml] [--json]
	  sovryn discover-daemon survivor-adjacent-claims [--live-openml] [--json]
		  ...
		  sovryn discover-daemon all-layer-100-closure [--json]
...
async function nobelReadinessCommand(
  ...
  switch (subcommand) {
    ...
    case "public-review-url-audit": {
      ...
      if (!targetRepo) {
        throw new AppError(
          "NOBEL_READINESS_TARGET_REPO_REQUIRED",
          "Use: sovryn nobel-readiness public-review-url-audit --target-repo <path>.",
        );
      }
      return service.publicReviewUrlAudit(targetRepo);
    }
...
async function discoverDaemonCommand(
  ...
  switch (subcommand) {
    ...
    case "insight-gauntlet":
      return service.insightGauntlet({
    ...
    case "marathon": {
      ...
      if (action === "depth-gauntlet") return service.marathonDepthGauntlet();
      if (action === "gate-closure-autopsy") {
        return service.marathonGateClosureAutopsy();
      }
    ...
    case "generator-families":
      return service.generatorFamilies({
    ...
    case "generator-insight-closure":
      return service.generatorInsightClosure();
    case "generator-fund-closure":
      return service.generatorFundClosure();
    case "generator-claim-lift-propose":
      return service.generatorClaimLiftPropose();
    case "generator-claim-lift":
      return service.generatorClaimLift();
    case "generator-claim-lift-pressure":
      return service.generatorClaimLiftPressure();
    case "generator-claim-lift-experiment":
      return service.generatorClaimLiftExperiment();
    case "generator-claim-lift-source-signal":
      return service.generatorClaimLiftSourceSignal();
    case "generator-claim-lift-novelty-pressure":
      return service.generatorClaimLiftNoveltyPressure();
    case "generator-claim-lift-death-memory":
      return service.generatorClaimLiftDeathMemory();
    case "generator-claim-lift-candidate":
      return service.generatorClaimLiftCandidate();
    case "generator-claim-lift-rebind":
      return service.generatorClaimLiftRebind();
    case "generator-claim-lift-intake":
      return service.generatorClaimLiftIntake();
    case "dimacs-boundary-closure":
      return service.dimacsBoundaryClosure();
    case "formal-anchor-select":
      return service.formalAnchorSelect();
    case "formal-anchor-pilot":
      return service.formalAnchorPilot();
    case "formal-anchor-audit":
      return service.formalAnchorAudit();
    case "formal-anchor-pressure":
      return service.formalAnchorPressure();
    case "source-object-engine": {
      const action = parsed.positionals[1];
      if (!action) return service.sourceObjectEngine();
      if (action === "status") return service.sourceObjectEngineStatus();
      if (action === "audit") return service.sourceObjectEngineAudit();
      throw new AppError(
        "UNKNOWN_DISCOVER_DAEMON_SOURCE_OBJECT_ENGINE_COMMAND",
        `Unknown discover-daemon source-object-engine command: ${action}`,
      );
    }
    ...
    case "discovery-anchor-select":
      return service.discoveryAnchorSelect();
    case "discovery-anchor-audit":
      return service.discoveryAnchorAudit();
    case "discovery-anchor-source-load":
      return service.discoveryAnchorSourceLoad({
        anchorId: flagString(parsed.flags, "--anchor") ?? undefined,
      });
    case "discovery-anchor-run":
      return service.discoveryAnchorRun();
    case "discovery-anchor-run-audit":
      return service.discoveryAnchorRunAudit();
    ...
    case "strategy-memory-gate":
      return service.strategyMemoryGate();
    case "memory-gated-benchmark-upgrade":
      return service.memoryGatedBenchmarkUpgrade();
    case "insight-temporal-recurrence-promotion":
      return service.insightTemporalRecurrencePromotion();
    case "insight-temporal-replay-repair":
      return service.insightTemporalReplayRepair();
    case "task-receipt-first-benchmark":
      return service.taskReceiptFirstBenchmarkDiscovery({
        liveOpenMl: flagBool(parsed.flags, "--live-openml"),
      });
    case "receipt-first-synthesis":
      return service.receiptFirstSynthesis({
        liveOpenMl: flagBool(parsed.flags, "--live-openml"),
      });
    case "receipt-first-selectivity":
      return service.receiptFirstSelectivityChallenge({
        liveOpenMl: flagBool(parsed.flags, "--live-openml"),
      });
    case "receipt-first-selectivity-promotion":
      return service.receiptFirstSelectivityPromotion({
        liveOpenMl: flagBool(parsed.flags, "--live-openml"),
      });
    case "receipt-first-selectivity-v2":
      return service.receiptFirstSelectivityV2({
        liveOpenMl: flagBool(parsed.flags, "--live-openml"),
      });
    ...
    case "receipt-first-survival-potential":
      return service.receiptFirstSurvivalPotential({
        liveOpenMl: flagBool(parsed.flags, "--live-openml"),
      });
    case "receipt-first-v2-survivor-yield":
      return service.receiptFirstV2SurvivorYield({
        liveOpenMl: flagBool(parsed.flags, "--live-openml"),
      });
    case "deep-validation-gold-set-calibration":
      return service.deepValidationGoldSetCalibration({
        liveOpenMl: flagBool(parsed.flags, "--live-openml"),
      });
    case "survivor-adjacent-claims":
      return service.survivorAdjacentClaims({
        liveOpenMl: flagBool(parsed.flags, "--live-openml"),
      });
    case "survivor-adjacent-promotion":
      return service.survivorAdjacentPromotion({
        liveOpenMl: flagBool(parsed.flags, "--live-openml"),
      });
    case "second-independent-survivor":
      return service.secondIndependentSurvivor({
        liveOpenMl: flagBool(parsed.flags, "--live-openml"),
      });
    case "second-survivor-fund-draft":
      return service.secondSurvivorFundDraftReadiness();
    case "second-survivor-methodology-evidence":
      return service.secondSurvivorMethodologyEvidence();
    case "all-layer-100-closure":
      return service.allLayer100Closure();
    case "cycle":
